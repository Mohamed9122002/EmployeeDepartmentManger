...
<form method="POST" action="" class="max-w-md mx-auto bg-white p-6 rounded-xl shadow-md space-y-4 mt-10">
  <h2 class="text-2xl font-semibold text-center text-gray-800 mb-4">Add New Wife</h2>
   <div>
    <label for="Name" class="block mb-1 text-gray-700 font-medium">Wife Name</label>
    <input type="text" name="Name" id="Name" placeholder="Wife Name"
