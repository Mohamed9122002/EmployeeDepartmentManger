                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/" aria-current="page"
                            class=" bg-gray-900 text-white text-gray-300 rounded-md  px-3 py-2 text-sm font-medium text-white">Employee</a>
                        <a href="/department"
                            class=" bg-gray-900 text-white text-gray-300  rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Department</a>
                        <a href="/select/employee"
                            class=" bg-gray-900 text-white text-gray-300  rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Select Employee</a>
                    </div>
                </div>
            </div>
            <div class="hidden md:block">
